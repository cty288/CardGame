...
namespace MainGame {
	public class BoxingGloves : CardInfo {
	public BoxingGloves () {}
	public BoxingGloves(CardProperties attributes) : base(attributes) {}
	...
	public override List<EffectCommand> SetInitialEffects() {
		return new List<EffectCommand>() {
			new AddPropertyValueToRandomFriendlyCharactersEffects(2,3,3)
		};
	}
