...
namespace MainGame {
	public class MagicTalisman : CardInfo {
	public MagicTalisman () {}
	public MagicTalisman(CardProperties attributes) : base(attributes) {}
	...
	public override List<EffectCommand> SetInitialEffects() {
		return new List<EffectCommand>() {
			new OnFriendlyCharacterReceiveCertainDamage(10, new ReduceCostInHandsEffect(1))
		};
	}
